    ...
    <div className="max-w-6xl mx-auto p-2">
      <nav className="flex justify-between">
        ...
        <div className="flex items-center space-x-4 text-sm">
          ...
          <Link href={"/addItem"} className="flex items-center gap-2 link">
            Add to Inventory
      ...
      <section className="flex items-center space-x-2 py-5">
        ...
        <button
          type="button"
          className="hidden sm:inline bg-blue-600 text-white px-5 md:px-10 py-2 border-2 border-blue-600 cursor-pointer"
        >
          Search
        </button>
        ...
        <Link href="/create">
          <button
            type="button"
            className="border-2 border-blue-600 px-5 md:px-10 py-2 text-blue-600 hover:bg-blue-600/50 hover:text-white cursor-pointer"
          >
            List Item
          </button>
        </Link>
      ...
      <section className="flex items-center space-x-6 py-3 text-xs md:text-sm justify-center whitespace-nowrap px-6">
